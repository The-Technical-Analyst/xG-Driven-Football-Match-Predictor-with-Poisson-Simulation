...
home_games = 5
home_G = 10     # Actual goals scored by home team in previous match
home_GA = 2    # Actual goals conceded by home team
home_xG = 7.7  # Home team expected goals
home_xGA = 4.6 # Home team expected goals against (xGA)

away_games = 5
away_G = 10     # Actual goals scored by away team in previous match
away_GA = 3    # Actual goals conceded by away team
away_xG = 8.2  # Away team expected goals
away_xGA = 4.2 # Away team expected goals against (xGA)
...
for outcome in ["Over 0.5", "Over 1.5", "Over 2.5", "Over 3.5"]:
    print(f"{outcome}: Probability: {total_probabilities[outcome]:.2%}, Odds: {total_odds[outcome]:.2f}")
print()  # Blank line
